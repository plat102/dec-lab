...
Yêu cầu: https://unigap-tech-coaching.notion.site/Linux-CMD-Project-11e04bc026004c3298e85bba8919630a
...
```bash
[3/8]: Tìm ra phim nào có doanh thu cao nhất và doanh thu thấp nhất
--------------------------------------------------
----- Phim có doanh thu CAO NHẤT:
 -> [Doanh thu: $2781505847] Avatar
...
```bash
[4/8]: Tính tổng doanh thu tất cả các bộ phim
--------------------------------------------------
432720192875
```
